...
# name for script
#SBATCH -J ma2_train_mlp

# controll job outputs
#SBATCH -o lunarc_output/MA2_noisy_data/outputs_ma2_train_mlp_%j.out
#SBATCH -e lunarc_output/MA2_noisy_data/errors_ma2_train_mlp_%j.err
