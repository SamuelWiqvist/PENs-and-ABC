...
# name for script
#SBATCH -J gandk_multi_ABC_deepsets3
...
# run program
julia /home/samwiq/'ABC and deep learning project'/abc-dl/src/'g and k dist'/multiple_ABC_runs_deepsets.jl standard 500 3 0
