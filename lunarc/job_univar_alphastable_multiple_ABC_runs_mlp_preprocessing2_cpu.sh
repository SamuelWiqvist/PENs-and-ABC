...
# name for script
#SBATCH -J univ_alphastable_multi_ABC_mlp_preprocessing2
...
# run program
julia /home/samwiq/'ABC and deep learning project'/abc-dl/src/'alpha stable dist'/multiple_ABC_runs_mlp_preprocessing.jl standard 250 100 100 50 2 0
