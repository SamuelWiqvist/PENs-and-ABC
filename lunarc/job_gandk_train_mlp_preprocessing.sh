...
# name for script
#SBATCH -J gandk_mlp_preprocessing

# controll job outputs
#SBATCH -o lunarc_output/gandk/outputs_gandk_mlp_preprocessing_%j.out
#SBATCH -e lunarc_output/gandk/errors_gandk_mlp_preprocessing_%j.err
