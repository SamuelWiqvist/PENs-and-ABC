...
# name for script
#SBATCH -J univ_alphastable_multi_ABC_dnn_small4
...
# run program
julia /home/samwiq/'ABC and deep learning project'/abc-dl/src/'alpha stable dist'/mutiple_ABC_runs_simple_dnn.jl simple_DNN_small standard 100 100 100 50 4 0
