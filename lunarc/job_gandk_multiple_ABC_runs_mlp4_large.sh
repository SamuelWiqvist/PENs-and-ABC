...
# run program
julia /home/samwiq/'ABC and deep learning project'/abc-dl/src/'g and k dist'/multiple_ABC_runs_mlp.jl mlp standard 250 100 100 50 4 0 large
