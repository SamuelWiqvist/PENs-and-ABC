...
include(pwd()*"/src/alpha stable dist/train_simple_dnn_network.jl")
...
for i = 5:4:(4*N-1)
    ...
    approx_posterior_samples = @time abcrs(y_obs_input, proposalas[1:100000,:], datasets_input[1:100000,:], calc_summary, ρ, return_data=false; cutoff_percentile=5*0.02)
