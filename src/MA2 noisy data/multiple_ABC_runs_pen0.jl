...
include(pwd()*"/src/MA2 noisy data/train_bp_pen0.jl")
...
CSV.write("/lunarc/nobackup/users/samwiq/abc-dl/data/MA2 noisy data/posteriors_multiple_data_sets_"*job*".csv", DataFrame(posteriors))
